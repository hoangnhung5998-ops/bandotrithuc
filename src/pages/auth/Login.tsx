        ...
        <div className="hidden md:block md:w-[50%] relative overflow-hidden bg-[#eef2f7] flex flex-col">
          ...
          <div className="p-6 bg-white/50 backdrop-blur-sm border-t border-slate-100 flex flex-col items-center gap-1">
            ...
            <div className="flex gap-4">
              <p className="text-slate-400 text-[10px]">
                <span className="font-semibold text-slate-500">Zalo:</span> <span className="text-emerald-600 font-bold">0967414304</span>
              </p>
              <p className="text-slate-400 text-[10px]">
                <span className="font-semibold text-slate-500">Facebook:</span> <span className="text-emerald-600 font-bold">Hoàng Nhung</span>
              </p>
            </div>
          </div>
        </div>
